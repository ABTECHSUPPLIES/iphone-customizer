...
# iPhone models with colors, storage, updated pricing, and images
IPHONE_DATA = {
    "iPhone 11": {
        "base_price": 399,  # Was 499, now 20% off
        "colors": ["Black", "White", "Green", "Yellow", "Purple", "Red"],
        "storage": {64: 0, 128: 40, 256: 80},  # Adjusted storage premiums
        "images": {
    ...
    "iPhone 11 Pro": {
        "base_price": 799,  # Was 999, now 20% off
        "colors": ["Space Gray", "Silver", "Gold", "Midnight Green"],
        "storage": {64: 0, 256: 120, 512: 280},  # Adjusted storage premiums
        "images": {
    ...
    "iPhone 11 Pro Max": {
        "base_price": 879,  # Was 1099, now 20% off
        "colors": ["Space Gray", "Silver", "Gold", "Midnight Green"],
        "storage": {64: 0, 256: 120, 512: 280},  # Adjusted storage premiums
        "images": {
            "Space Gray": "static/images/iPhone_11_Pro/Space_Gray/iPhone 11 Pro.jpeg",
    ...
    "iPhone 12": {
        "base_price": 479,  # Was 599, now 20% off
        "colors": ["Black", "White", "Blue", "Green", "Red", "Purple"],
        "storage": {64: 0, 128: 40, 256: 120},  # Adjusted storage premiums
        "images": {
    ...
    "iPhone 12 Pro": {
        ...
        "storage": {128: 0, 256: 80, 512: 240},  # Adjusted storage premiums
        "images": {
    ...
    "iPhone 13": {
        "base_price": 559,  # Was 699, now 20% off
        "colors": ["Pink", "Blue", "Midnight", "Starlight", "Red", "Green"],
        "storage": {128: 0, 256: 80, 512: 160},  # Adjusted storage premiums
        "images": {
    ...
    "iPhone 13 Pro": {
        ...
        "storage": {128: 0, 256: 80, 512: 240, 1024: 400},  # Adjusted storage premiums
        "images": {
    ...
    "iPhone 14": {
        "base_price": 639,  # Was 799, now 20% off
    ...
    "iPhone 15 Pro Max": {
        "base_price": 959,  # Was 1199, now 20% off
        "colors": ["Black Titanium", "White Titanium", "Natural Titanium", "Blue Titanium"],
        "storage": {256: 0, 512: 160, 1024: 320},  # Adjusted storage premiums
        "images": {
            "Black Titanium": "static/images/iPhone_15_Pro/Black_Titanium/IPhone 15 Pro Black Titanium.jpeg",
            "White Titanium": "static/images/iPhone_15_Pro/White_Titanium/Apple Iphone 15 Pro Max titanium Branco - link abaixo de como tirar foto com iphone.jpeg",
            "Natural Titanium": "static/images/iPhone_15_Pro/Natural_Titanium/iphone 15 pro natural titanium.jpeg"
